# repoquill Usage Skill

Documentation for repoquill

Agent skill for using repoquill in testing and evaluation workflows.
...
- User asks about repoquill capabilities, setup, or results
...
1. Python implementation (`repoquill/*.py`)
2. Tests (`tests/`)
...
repoquill is a testing/evaluation tool. You use it to:
...
1. **Never invent API names.** Verify class/function names against `repoquill/__init__.py` and the reference pages.
...
- Repo: https://github.com/SushantGautam/RepoQuill
- Site: https://SushantGautam.github.io/RepoQuill/
- Package: `repoquill`
