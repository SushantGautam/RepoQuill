...
**Last updated:** 2026-08-29 (E50: GitHub source permalinks — mkdocstrings "Source code in" labels now render as clickable links to the exact line range on GitHub/GitLab. E49b: auto-populate module descriptions from docstrings. E49 KEEP: auto-detect package_dir + deterministic API Reference fallback. E48 KEEP: index.md landing page auto-generates real tagline + quick_start + per-guide descriptions. E47 KEEP: deterministic type-annotation verification pass eliminates C-hallucination)
...
| E50 | GitHub source permalinks (Griffe source_link → mkdocstrings patch) | — | — | — | **KEEP** (fbd308c — "Source code in" labels now clickable GitHub/GitLab permalinks) |
