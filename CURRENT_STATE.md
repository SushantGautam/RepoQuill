...
**Last updated:** 2026-08-29 (E49 KEEP: auto-detect package_dir + deterministic API Reference fallback — fixes empty API Reference in index.md/nav/llms.txt when package_dir not set. E48 KEEP: index.md landing page auto-generates real tagline + quick_start + per-guide descriptions. E47 KEEP: deterministic type-annotation verification pass eliminates C-hallucination)
